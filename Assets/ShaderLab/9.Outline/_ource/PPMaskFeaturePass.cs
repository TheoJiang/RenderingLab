...
// {
    [MovedFrom("UnityEngine.Experimental.Rendering.LWRP")] public class PPMaskFeaturePass : ScriptableRenderPass
    {
        RenderQueueType renderQueueType;
        FilteringSettings m_FilteringSettings;
        PPMaskFeature.CustomCameraSettings m_CameraSettings;
        ...
        public PPMaskFeaturePass(string profilerTag, RenderPassEvent renderPassEvent, string[] shaderTags, RenderQueueType renderQueueType, int layerMask, PPMaskFeature.CustomCameraSettings cameraSettings)
        {
